...
public class OutgoingDocumentController {
    ...
    public ResponseEntity<ResponseDTO<Page<OutgoingDocumentDTO>>> getAllOutgoingDocuments(Pageable pageable) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ResponseDTO.error("Lỗi khi lấy danh sách văn bản đi: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ResponseDTO<Page<OutgoingDocumentDTO>>> findByDocumentType(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ResponseDTO.error("Lỗi khi lọc văn bản theo loại: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ResponseDTO<OutgoingDocumentDTO>> createOutgoingDocument(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(ResponseDTO.success("Tạo văn bản đi thành công", createdDocument));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ResponseDTO.error("Không thể tạo văn bản đi: " + e.getMessage()));
        }
    }
    ...
    /**
     * Tải xuống tệp đính kèm của văn bản đến liên quan đến văn bản đi
     */
    ...
    public ResponseEntity<ResponseDTO<List<OutgoingDocumentDTO>>> getRelatedDocuments(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ResponseDTO.error("Lỗi khi tìm kiếm văn bản liên quan: " + e.getMessage()));
        }
    }
}